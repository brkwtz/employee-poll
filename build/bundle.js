...
"use strict";
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/brkwtz/Job Applications/Code Tests/employee-poll/node_modules/react/react.js'\n    at Error (native)");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__StaticRouter__ = __webpack_require__(145);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Switch__ = __webpack_require__(146);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__withRouter__ = __webpack_require__(147);
...
exports.loadForm = exports.setMoodAttributes = exports.enableSubmit = exports.submitFeedback = exports.submitAnswers = exports.getAndSetMood = exports.getFormData = exports.ENABLE_SUBMIT = exports.SUBMIT_FEEDBACK = exports.ANSWER_QUESTION = exports.SET_MOOD = exports.GET_FORM_DATA = undefined;
...
var GET_FORM_DATA = exports.GET_FORM_DATA = "GET_FORM_DATA";
var SET_MOOD = exports.SET_MOOD = "SET_MOOD";
var ANSWER_QUESTION = exports.ANSWER_QUESTION = "ANSWER_QUESTION";
var SUBMIT_FEEDBACK = exports.SUBMIT_FEEDBACK = "SUBMIT_FEEDBACK";
...
var getAndSetMood = exports.getAndSetMood = function getAndSetMood(mood, ratingResponseSegment, ratingImageUrlSegment) {
  return {
    type: SET_MOOD,
    mood: mood,
...
var submitAnswers = exports.submitAnswers = function submitAnswers(questions) {
  return {
...
var submitFeedback = exports.submitFeedback = function submitFeedback(feedback) {
  return {
...
var enableSubmit = exports.enableSubmit = function enableSubmit() {
  return {
    type: ENABLE_SUBMIT,
    submittable: true
  };
...
//--------FUNCTIONS------//
var setMoodAttributes = exports.setMoodAttributes = function setMoodAttributes(mood) {
...
var _Poll = __webpack_require__(290);
...
(0, _reactDom.render)(_react2.default.createElement(
  ...
  _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      { exact: true, path: '/' },
      _react2.default.createElement(_reactRouterDom.Route, { path: '/demo-question/:mood', component: _Poll2.default })
    )
  )
...
"use strict";
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/brkwtz/Job Applications/Code Tests/employee-poll/node_modules/react-dom/index.js'\n    at Error (native)");
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(64), __webpack_require__(107)(module)))
...
var _ThankYouBox = __webpack_require__(291);

var _ThankYouBox2 = _interopRequireDefault(_ThankYouBox);

var _ExtraFeedbackBox = __webpack_require__(292);

var _ExtraFeedbackBox2 = _interopRequireDefault(_ExtraFeedbackBox);

var _PollQuestions = __webpack_require__(293);

var _PollQuestions2 = _interopRequireDefault(_PollQuestions);

var _SubmittedBox = __webpack_require__(296);

var _SubmittedBox2 = _interopRequireDefault(_SubmittedBox);
...
var Poll = function (_React$Component) {
  ...
  _createClass(Poll, [{
    ...
    value: function componentWillMount() {
      ...
      _store2.default.dispatch((0, _reducer.setMoodAttributes)(this.props.match.params.mood));
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'a',
            { href: 'https://support.butterfly.ai/' },
            _react2.default.createElement('img', { id: 'butterfly', src: '../images/Butterfly.svg' })
          ),
          _react2.default.createElement('img', { id: 'infoicon', src: '../images/InfoIcon.svg' })
        ),
        _react2.default.createElement(
          'div',
          ...
          this.state.submitted ? _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(_SubmittedBox2.default, null)
          ) : _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(_ThankYouBox2.default, { managers: this.state.managers, mood: this.state.mood, ratingResponse: this.state.ratingResponse, ratingImageUrl: this.state.ratingImageUrl }),
            _react2.default.createElement(_PollQuestions2.default, { questions: this.state.questions }),
            _react2.default.createElement(_ExtraFeedbackBox2.default, null),
            _react2.default.createElement(
              'div',
              null,
              submittable ? _react2.default.createElement(
                'button',
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { id: "editIcon" },
          _react2.default.createElement("img", { src: "../images/EditIcon.svg" })
        ),
        _react2.default.createElement(
          "div",
          { id: "header" },
          _react2.default.createElement("img", { id: "ratingImage", src: this.props.ratingImageUrl })
        ),
        _react2.default.createElement(
          "div",
          { id: "anonymousMessage" },
          _react2.default.createElement(
            "h1",
            null,
            this.props.ratingResponse
          ),
          _react2.default.createElement(
            "p",
            null,
            "Your answers will always remain anonymous and will be viewed by the following managers:"
          ),
...
var ExtraFeedbackBox = function (_React$Component) {
  _inherits(ExtraFeedbackBox, _React$Component);

  function ExtraFeedbackBox(props) {
    _classCallCheck(this, ExtraFeedbackBox);

    var _this = _possibleConstructorReturn(this, (ExtraFeedbackBox.__proto__ || Object.getPrototypeOf(ExtraFeedbackBox)).call(this, props));

    _this.handleTextEnter = _this.handleTextEnter.bind(_this);
    return _this;
  }

  _createClass(ExtraFeedbackBox, [{
    key: 'handleTextEnter',
    value: function handleTextEnter(e) {
      e.preventDefault();
      var commentText = e.target.value;
      (0, _reducer.submitFeedback)(commentText);
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'question', id: 'extraFeedback' },
        _react2.default.createElement(
          'h1',
          null,
          'Anything to Add?'
        ...
        _react2.default.createElement(
          'form',
          null,
          _react2.default.createElement('textarea', { className: 'comment', onChange: this.handleTextEnter, placeholder: 'Anything to add?' })
        )
      );
    }
  }]);

  return ExtraFeedbackBox;
}(_react2.default.Component);

exports.default = ExtraFeedbackBox;
...
var _QuestionBox = __webpack_require__(295);
...
var PollQuestions = function (_React$Component) {
  _inherits(PollQuestions, _React$Component);

  function PollQuestions() {
    _classCallCheck(this, PollQuestions);

    return _possibleConstructorReturn(this, (PollQuestions.__proto__ || Object.getPrototypeOf(PollQuestions)).apply(this, arguments));
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        questions.length ? questions.map(function (question) {
          return _react2.default.createElement(_QuestionBox2.default, { questions: questions, key: question.prompt, question: question });
        }) : null
      );
    }
  }]);
...
var QuestionBox = function (_React$Component) {
  ...
  function QuestionBox(props) {
    ...
    _this.handleAddCommentClick = _this.handleAddCommentClick.bind(_this);
    _this.handleRatingClick = _this.handleRatingClick.bind(_this);
    _this.handleTextEnter = _this.handleTextEnter.bind(_this);
    return _this;
  }
  ...
  _createClass(QuestionBox, [{
    ...
    value: function handleAddCommentClick(e) {
      e.preventDefault();
      this.setState({ commentVisible: true });
    }
  }, {
    key: 'handleRatingClick',
    value: function handleRatingClick(e, val) {
      e.preventDefault();
      var thisQuestion = this.props.question;
      var allQuestions = this.props.questions;
      // save rating to state
      var index = allQuestions.indexOf(thisQuestion);
      if (index !== -1) {
        allQuestions[index].rating = val;
      }
      (0, _reducer.submitAnswers)(allQuestions);
      ...
      disabled ? null : (0, _reducer.enableSubmit)();
    }
  }, {
    key: 'handleTextEnter',
    value: function handleTextEnter(e) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            ratings.map(function (rating) {
              return _react2.default.createElement('input', { name: 'rating', className: 'barRadio', type: 'radio', key: rating, value: rating, onClick: function onClick(e) {
                  return _this2.handleRatingClick(e, rating);
                } });
            })
          )
        ),
        ...
        _react2.default.createElement(
          'form',
          null,
          this.state.commentVisible ? _react2.default.createElement('textarea', { className: 'comment', style: this.state.commentStyle, onChange: this.handleTextEnter, placeholder: 'Anything to add or suggest to your manager?' }) : _react2.default.createElement(
            'button',
            { className: 'commentButton', onClick: this.handleAddCommentClick },
            'Add comment'
          )
        )
      );
...
var SubmittedBox = function (_React$Component) {
  _inherits(SubmittedBox, _React$Component);

  function SubmittedBox() {
    _classCallCheck(this, SubmittedBox);

    return _possibleConstructorReturn(this, (SubmittedBox.__proto__ || Object.getPrototypeOf(SubmittedBox)).apply(this, arguments));
  }

  _createClass(SubmittedBox, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement(
        "div",
